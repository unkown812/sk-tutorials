...
const Students: React.FC = () => {
  ...
  // Removed unused feeAmount state to fix eslint warning
      ...
      if (error) {
        ...
        const studentsWithDue = (data || []).map((student) => {
          ...
          if (dueAmount === totalFee) {
            ...
            feeStatus = "Paid";
          } else if (dueAmount > 0 && dueAmount < totalFee) {
            feeStatus = "Partial";
          } else {
            feeStatus = "Unpaid";
          }
  ...
  const handleAddStudentSubmit = async () => {
    ...
    try {
      ...
      // Removed unused variable installmentsNum to fix eslint warning
                    ...
                    .forEach((yearStr) => {
                      ...
                      rows.push(
                        <tr
                          ...
                          className="bg-white hover:bg-orange-100 focus:bg-orange-200"
                        >
                          <td
                            colSpan={11}
            ...
            <div className="mt-6">
              ...
              <button
                ...
                onClick={async () => {
                  ...
                  setAddError(null);
                  try {
                    // Calculate paid_fee as sum of installment_amt
                    const paidFeeSum = newStudent.installment_amt
                      ...
                      : 0;
                    // Update student record with correct fields
                    const { error } = await supabase
                      .from("students")
                      .update({
